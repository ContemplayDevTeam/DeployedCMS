...
export async function GET() {
  try {
    ...
    // Try to access the table without any filters to see if it exists
    const url = `https://api.airtable.com/v0/${baseId}/tblXfgLJOJH94UGwD?maxRecords=1`
    ...
    console.error('Table exists test error:', error)
    return NextResponse.json({
